...
custom_root_directory = "Shuoyi's Flie/SSH_circular/data_SSH_circular_omega_0.16"  # Replace with your desired path
...
def figure(occ_state_energy, con_state_energy, k_values):
    save_folder = "Shuoyi's Flie/SSH_circular/Plot_SSH_circular_omega_0.16"
