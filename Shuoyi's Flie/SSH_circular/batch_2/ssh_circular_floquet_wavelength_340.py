...
custom_root_directory = "Shuoyi's Flie/SSH_circular/Plot_SSH_circular_wavelength_440"  # Replace with your desired path
...
def figure(occ_state_energy, con_state_energy, k_values):
    save_folder = "Shuoyi's Flie/SSH_circular/Plot_SSH_circular_wavelength_440"
...
E0_values_1 = np.linspace(0, 0.0001, 11)       # Field amplitudes E0 in 
E0_values_2 = np.linspace(0, 0.02, 201)       # Field amplitudes E0 in
t0, xi           = 1.0, 0.5
