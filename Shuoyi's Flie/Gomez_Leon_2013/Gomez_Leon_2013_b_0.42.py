...
custom_root_directory = "Shuoyi's Flie/Gomez_Leon_2013/data_Gomez_Leon_2013_test"  # Replace with your desired path
...
def figure(occ_state_energy, cond_state_energy, k_values):
    save_folder = "Floquet_Band_Plots_Gomez_Leon_2013_test"
...
E0_over_omega_values = np.linspace(0, 1, 101) 
b_values = [0.41, 0.42]
