...
class Heisenberg:
    ...
    def TDDMRG(self, psi0=None, dt=0.01, nt=10):
        if psi0 is None:
...
print(f"Initializing Heisenberg Chain with {N} sites")
# H_mpo = build_heisenberg_mpo(N)

mol = Heisenberg(N)
psi0 = mol.build_neel_state()
