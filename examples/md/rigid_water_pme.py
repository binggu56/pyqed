...
def parse_args():
    ...
    parser.add_argument("--timestep-fs", type=float, default=0.1, help="Timestep in fs.")
    ...
    parser.add_argument("--friction", type=float, default=1e-2, help="Langevin friction in inverse atomic time.")
