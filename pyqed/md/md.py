...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 26 08:50:57 2026

BOMD

adapted from ASE and PySCF
...
class Dynamics:
    ...
    trajectory: Trajectory object or str
        ...
        trajectory.
    """
    def __init__(self, mol, logfile, trajectory):
        self.atoms = self.mol = mol
        ...
        if trajectory is not None:
            if isinstance(trajectory, str):
                trajectory = PickleTrajectory(trajectory, 'w', mol)
...
class _Integrator:
    ...
    def __init__(self, method, **kwargs):
        ...
        if getattr(method, 'nuc_grad', None):
            self.scanner = method.nuc_grad().as_scanner()
        else:
