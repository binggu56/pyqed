...
class MDEngine:
    ...
    def __init__(
        ...
        self.dynamics = self._make_dynamics(temperature_K=temperature_K, friction=friction)
    ...
    def _make_dynamics(self, temperature_K=None, friction=None):
        ...
        if self.ensemble in {"nvt", "langevin"}:
            ...
            if friction is None:
                raise ValueError("friction is required for Langevin/NVT MD.")
            return Langevin(
                self.atoms,
                self.timestep,
