...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep  9 15:39:11 2024

@author: Bing Gu (gubing@westlake.edu.cn)
"""

import numpy as np 
from numpy.linalg import eye, sqrt
...
def simultaneous_diagonalization():
    ...
    # % A version for the complex case is available upon request.
    # %-----------------------------------------------------
    # % Two References:
    # %
    ...
    if nargin==1: threshold=sqrt(eps)
