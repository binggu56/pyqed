...
class HydrogenChain(ShinMetiu1d):
    def __init__(self, z, nstates=None, nelec=2, dvr_type='sine', spin=0, diag_method = 'scipy'):

        super.__init__(method = diag_method, nstates=nstates, nelec=nelec, \
                       dvr_type=dvr_type, spin=spin)
        
        self.geometry = self.atom_coords = z
