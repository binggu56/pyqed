...
!      call seed(idum,Ndim)
      ...
      write(*,1010) Ntraj,Ndim,kmax,dt,cf0,amhe
...
! ----- half-step increments of momenta & full step increment of positions
        do i=1,Ntraj
          ...
          call local(q,v,dv)
          do j=1,Ndim
              p(j,i)=p(j,i)+(-dv(j)+qf(j,i)-cf(j)*p(j,i))*dt2
...
!          do i=1,Ntraj
!        write(104,1000) x(1,i),x(2,i),x(3,i)
!          enddo
