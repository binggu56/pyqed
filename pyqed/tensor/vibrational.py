# -*- coding: utf-8 -*-
"""
Created on Tue Aug 23 11:00:01 2022


@task: tensor network based method for vibrational dynamics
"""
...
def make_U_mpo(d, L, dt, dtype=float):
    ...
    Not finished. Think how to construct the propagator. 
    ...
    This MPO generates
    ..math::
        H = \omega_0 a^\dag_i a_i + (\sum_{<i,j>} a_i a_j^\dagger + H.c.)

    """

    # dim of vibrational space
