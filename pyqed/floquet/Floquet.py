...
class Floquet:
    ...
    def winding_number_Peierls_GL2013_2(self, k, quasi_E = None, previous_state = None, gauge='length',w=0.2, b=0.5, t=1, E_over_omega = 1): # To be modified
        H0 = self.H
        E0 = self.E0
        nt = self.nt 
        omegad = self.omegad
        occ_state, occ_state_energy = Floquet_Winding_number_Peierls_GL2013_2(H0, k, nt, E_over_omega, quasi_E, previous_state, w=w, b=b, t=t)
        return occ_state, occ_state_energy
...
def Floquet_Winding_number_Peierls_GL2013_2(H0, k, Nt, E_over_omega ,quasiE = None, previous_state = None, w = 0.2, b=0.5, t=1):
    """
    Build and diagonalize the Floquet Hamiltonian for a 1D system,
    then group the 2*N_t eigenvalues/eigenstates into two Floquet bands.
    choose the correct Floquet branch if E = 0 (by comparing with the directly diagonalized energies)
