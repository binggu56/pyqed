...
class Floquet:
    ...
    # def winding_number_Peierls_2(self, T, k, quasi_E = None, previous_state = None, gauge='length',w=0.2): # To be modified
    #     H0 = self.H
    #     E0 = self.E0
    #     nt = self.nt 
    #     omegad = self.omegad
    #     occ_state, occ_state_energy = Floquet_Winding_number_Peierls_2(H0, k, nt, omegad, T, E0, quasi_E, previous_state, w=w)
    #     return occ_state, occ_state_energy
