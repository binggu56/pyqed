...
def contracted_eri_ssss_rys(a, b, c, d):
    ...
    return _contracted_eri_ssss_rys_cached(
        _basis_signature(a), _basis_signature(b), _basis_signature(c), _basis_signature(d)
    )
...
def contracted_eri_psss_rys(a, b, c, d):
    ...
    return _contracted_eri_psss_rys_cached(
        _basis_signature(a), _basis_signature(b), _basis_signature(c), _basis_signature(d)
    )
...
def contracted_eri_ppss_rys(a, b, c, d):
    ...
    return _contracted_eri_ppss_rys_cached(
        _basis_signature(a), _basis_signature(b), _basis_signature(c), _basis_signature(d)
    )
...
def contracted_eri_psps_rys(a, b, c, d):
    ...
    return _contracted_eri_psps_rys_cached(
        _basis_signature(a), _basis_signature(b), _basis_signature(c), _basis_signature(d)
    )
...
def contracted_eri_ppps_rys(a, b, c, d):
    ...
    return _contracted_eri_ppps_rys_cached(
        _basis_signature(a), _basis_signature(b), _basis_signature(c), _basis_signature(d)
    )
...
def contracted_eri_pppp_rys(a, b, c, d):
    ...
    return _contracted_eri_pppp_rys_cached(
        _basis_signature(a), _basis_signature(b), _basis_signature(c), _basis_signature(d)
    )
