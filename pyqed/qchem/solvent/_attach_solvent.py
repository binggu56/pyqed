...
class CASCIWithSolvent(_Solvation):
    ...
    def get_hcore(self, mol=None):
        ...
        if self.with_solvent.v is not None:
            print('add solvent to hcoreeeeee')
    ...
    def run(self, nstates=1, max_cycle=None):
        ...
        def _dm_mo_for_state(istate):
            ...
            # 2) CASCI：走原逻辑
            return self.make_rdm1(istate, with_core=True)
        ...
        def _dm_ao_for_state(istate):
            ...
            C_act = C[:, :ncore+ncas]
            return C_act @ dm_mo @ C_act.conj().T
        ...
        for cycle in range(max_cycle):
            ...
            # print("v is None?", self.with_solvent.v is None)
            # if self.with_solvent.v is not None:
            #     print("||v||_F =", np.linalg.norm(self.with_solvent.v))
            # print("e =", self.with_solvent.e)
