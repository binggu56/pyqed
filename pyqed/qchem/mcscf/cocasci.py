...
def _fresh_casci_like(source):
    ...
    mc = CASCI(source.mf, ncas=source.ncas, nelecas=source.nelecas, tol=source.tol)
    mc.spin_purification = source.spin_purification
    mc.ss = source.ss
    mc.shift = source.shift
    mc.direct_ci_dense_fallback_ndets = source.direct_ci_dense_fallback_ndets
    mc.direct_ci_eigensolver = source.direct_ci_eigensolver
...
def kernel(mc, U0, nelecas, ncas, C0, h1e, eri, max_cycles=30, tol=1e-6,
    ...
    final_mc.direct_ci_dense_fallback_ndets = mc.direct_ci_dense_fallback_ndets
    final_mc.direct_ci_eigensolver = mc.direct_ci_eigensolver
    final_mc.direct_ci_max_cycle = mc.direct_ci_max_cycle
    final_mc.direct_ci_max_subspace = mc.direct_ci_max_subspace
    final_mc.direct_ci_reuse_guess = mc.direct_ci_reuse_guess
