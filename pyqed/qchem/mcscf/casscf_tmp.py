...
if __name__=='__main__':
    ...
    iter = [i+1 for i in range(num_iter)]
    print('iter', iter)
    e0 = mc.e_table[0, 0:num_iter]
    print('e0', e0)
    
    e0_lst = e0.tolist()
    print(e0_lst)
    # e1 = mc.e_table[1, 0:num_iter]
    # print('e1', e1)
    ...
    # plt.title("LiF cas(6,6)")
    # plt.savefig("save/2026_3_17/LiF_cas(6,6)_state_ave.png")
