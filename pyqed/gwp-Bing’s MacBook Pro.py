...
class WPD:
    ...
    def buildH(self):
        self.H = transform(self.buildK(), self.x_evecs) + self.buildV()
        return self.H
    ...
    def buildK(self):
        ...
        for k in range(N):
            ...
            for j in range(k):
                ...
                K[j, k] = (- ak**2/2./self.mass * (1./(aj + ak) + aj**2 * dq**2/(aj + ak)**2) - ak) * \
...
if __name__ == '__main__':
    ...
    sol = WPD(bases = [GWP(y, a=4) for y in x], mass=1)
