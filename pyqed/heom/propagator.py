...
rho = np.zeros((nsys, nsys), dtype=np.complex128)
rho[0, 0] = 1
hierarchy_liouvillian = deom_solver.hierarchy_liouvillian()
...
exp_i_L = la.expm(hierarchy_liouvillian * 0.01)
exp_i_L_n = exp_i_L
