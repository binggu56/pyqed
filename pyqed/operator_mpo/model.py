...
from .basis import BasisSet, BasisSimpleElectron, BasisMultiElectronVac, BasisHalfSpin, BasisSHO

from .operator import Op, OpSum

from .utils import Quantity, cached_property
...
class Model:
    ...
    def get_mpos(self, key: str, fun: Callable):
        ...
        fun : callable
            ...
            :class:`~pyqed.operator_mpo.ModelMPO`.

        Returns
        -------
        mpos : list of :class:`~pyqed.operator_mpo.ModelMPO`
            The required MPOs.
        """
